                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-control" name="question_type">
                                        ...
                                        @foreach($questionType as $item)
                                            <option {{ $question->questionType->question_type == $item->id ? "selected" : ""}} value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
{{--                                    <input type="text" name="question_type" class="form-control"--}}
{{--                                           id="exampleInputEmail1"--}}
{{--                                           placeholder="Enter Question Type Name" value="{{$question->questionType ? $question->questionType->name : ""}}">--}}
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-12">
