        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="col-md-6 col-4 align-self-center">
                    <a href="{{ route('school.create') }}" class="btn pull-right hidden-sm-down btn-success"><i
                            ...
                            @foreach($schools as $item)
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <a href="{{ route('school.edit', ['id' => $item->id]) }}" data-toggle="tooltip"
                                           data-original-title="Edit"><i class="flaticon-edit"></i>
                                        </a>
                                        <a href="{{ route('school.delete', ['id' => $item->id]) }}" data-toggle="tooltip"
