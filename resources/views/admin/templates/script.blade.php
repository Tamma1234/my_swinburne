...
<script src="{{asset('assets/plugins/general/tooltip.js')}}" type="text/javascript"></script>
...
<script src="{{asset('assets/plugins/general/typeahead.js')}}" type="text/javascript"></script>
...
<script src="{{asset('assets/plugins/general/morris.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/plugins/general/chart.js')}}" type="text/javascript"></script>
<script
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            url: "{{ route('exam.get') }}",
            method: 'POST',
            data: {id: id, _token: _token, exam_id:exam_id},
...
<script>
    ...
    @if (session('success'))
    swal("Notification", "{{ session('success') }}!", "success");
    @endif;

    @if (session('active'))
    swal("Notification", "{{ session('active') }}!", "success");
    @endif;
    ...
    $('.checkbox_wraper').on('click', function () {
        $(this).parents('.card-border-primary').find('.checkbox_childrent').prop('checked', $(this).prop('checked'));
    });
