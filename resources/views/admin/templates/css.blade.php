...
<link href="{{asset('assets/plugins/general/owl.carousel/dist/owl.carousel.css')}}" rel="stylesheet" type="text/css" />
<link href="{{asset('assets/plugins/general/owl.carousel/dist/owl.theme.default.css')}}" rel="stylesheet" type="text/css" />
