...
!function () {
    ...
    var s = function () {
        ...
        return s = t, r = [{
            ...
            key: "removeItemFromArray", value: function (t, i) {
                var o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                if (!Array.isArray(t) || !t.length) return t;
                var s = o ? e(t) : t, n = s.indexOf(i);
            ...
            key: "getRandomInt", value: function (e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, i = Math.ceil(t),
                    o = Math.floor(e);
                return Math.floor(Math.random() * (o - i - 1)) + i
            }
        }], (n = null) && o(s.prototype, n), r && o(s, r), Object.defineProperty(s, "prototype", {writable: !1}), t
    }();
    ...
    var p = function () {
        ...
        return t = e, o = [{
            ...
            key: "toggleClass", value: function (t, i, o) {
                var s;
            ...
            key: "getData", value: function (e, t, i) {
                if (e) {
                    var o = e ? e.dataset[t] : "";
            ...
            key: "setAttr", value: function (e, t, i) {
                e && e.setAttribute(t, i)
            }
        }, {
            key: "setAttrFromEle", value: function (e, t, i, o) {
                var s = {};
            ...
            key: "setStyle", value: function (e, t, i) {
                e && (e.style[t] = i)
            }
        }, {
            ...
            key: "setAria", value: function (e, t, i) {
                var o = t;
            ...
            key: "addEvent", value: function (t, i, o) {
            ...
            key: "dispatchEvent", value: function (t, i) {
                var o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
                if (t) {
            ...
            key: "getAttributesText", value: function (e) {
                ...
                return e ? (Object.entries(e).forEach((function (e) {
                    var i = n(e, 2), o = i[0], s = i[1];
                    void 0 !== s && (t += " ".concat(o, '="').concat(s, '" '))
                })), t) : t
            }
        }, {
            key: "convertPropToDataAttr", value: function (e) {
                return e ? "data-".concat(e).replace(/([A-Z])/g, "-$1").toLowerCase() : ""
            }
        }], (i = null) && u(t.prototype, i), o && u(t, o), Object.defineProperty(t, "prototype", {writable: !1}), e
    }();
    ...
    var O, S = {13: "onEnterPress", 38: "onUpArrowPress", 40: "onDownArrowPress"},
        ...
        E = function () {
            ...
            return t = e, o = [{
                ...
                key: "getAttrProps", value: function () {
                    var e = p.convertPropToDataAttr, t = {};
                ...
                key: "setPropsFromSelect", value: function (e) {
                    var t = e.ele, i = [], o = [], s = function e(t) {
                        var s = [];
                        return Array.from(t.children).forEach((function (t) {
                            var n = t.value, r = {value: n};
                ...
                key: "onFormReset", value: function (e) {
                ...
                key: "onFormSubmit", value: function (t) {
                ...
                key: "getSelectedOptionsMethod", value: function (e) {
                ...
                key: "toggleRequiredMethod", value: function (e) {
                ...
                key: "render", value: function () {
                    if (this.$ele) {
                        var e = this.uniqueId, t = "vscomp-wrapper",
                            i = this.getTooltipAttrText(this.placeholder, !0, !0),
                            o = this.getTooltipAttrText(this.clearButtonText),
                            s = this.ariaLabelledby ? 'aria-labelledby="'.concat(this.ariaLabelledby, '"') : "", n = !1;
                ...
                key: "renderOptions", value: function () {
                    var e, t = this, i = "", o = this.getVisibleOptions(), n = "", r = "",
                        a = !(!this.markSearchResults || !this.searchValue), l = this.labelRenderer,
                        u = this.disableOptionGroupCheckbox, p = this.uniqueId, h = this.searchGroup,
                        c = "function" == typeof l, d = s.convertToBoolean;
                    ...
                    o.forEach((function (o) {
                        var s, v = o.index, f = "vscomp-option", y = t.getTooltipAttrText("", !0, !0), b = n, g = "",
                            m = "", O = "", S = d(o.isSelected), x = "";
                ...
                key: "addEvent", value: function (e, t, i) {
                    ...
                    e && s.removeArrayEmpty(t.split(" ")).forEach((function (t) {
                        var s = "".concat(i, "-").concat(t), n = o.events[s];
                ...
                key: "onKeyDown", value: function (e) {
                    var t = e.which || e.keyCode, i = S[t];
                    i && this[i](e)
                }
            }, {
                key: "onEnterPress", value: function (e) {
                    e.preventDefault(), this.isOpened() ? this.selectFocusedOption() : this.openDropbox()
                }
            }, {
                key: "onDownArrowPress", value: function (e) {
                    e.preventDefault(), this.isOpened() ? this.focusOption({direction: "next"}) : this.openDropbox()
                }
            }, {
                key: "onUpArrowPress", value: function (e) {
                    e.preventDefault(), this.isOpened() ? this.focusOption({direction: "previous"}) : this.openDropbox()
                }
            }, {
                ...
                key: "onOptionsClick", value: function (e) {
                    ...
                    t && !p.hasClass(t, "disabled") && (p.hasClass(t, "group-title") ? this.onGroupTitleClick(t) : this.selectOption(t, {event: e}))
                }
            }, {
                ...
                key: "onOptionsMouseOver", value: function (e) {
                    var t = e.target.closest(".vscomp-option");
                    t && this.isOpened() && (p.hasClass(t, "disabled") || p.hasClass(t, "group-title") ? this.removeOptionFocus() : this.focusOption({$option: t}))
                }
            }, {
                ...
                key: "addMutationObserver", value: function () {
                    ...
                    if (this.hasDropboxWrapper) {
                        ...
                        this.mutationObserver = new MutationObserver((function (i) {
                            var o = !1, s = !1;
                            i.forEach((function (e) {
                                o || (o = y(e.addedNodes).some((function (e) {
                                    return !(e !== t && !e.contains(t))
                                }))), s || (s = y(e.removedNodes).some((function (e) {
                                    return !(e !== t && !e.contains(t))
                                })))
                            })), s && !o && e.destroy()
                ...
                key: "beforeSelectNewValue", value: function () {
                    var e = this, t = this.getNewOption(), i = t.index;
                ...
                key: "afterSetSearchValue", value: function () {
                    ...
                    this.hasServerSearch ? (clearInterval(this.serverSearchTimeout), this.serverSearchTimeout = setTimeout((function () {
                        e.serverSearch()
                    }), this.searchDelay)) : this.setVisibleOptionsCount(), this.selectAllOnlyVisible && this.toggleAllOptionsClass(), this.focusOption({focusFirst: !0})
                }
            }, {
                ...
                key: "setPropsFromElementAttr", value: function (e) {
                    ...
                    Object.keys(O).forEach((function (i) {
                        ...
                        -1 === x.indexOf(i) || "" !== o && "true" !== o || (o = !0), o && (e[O[i]] = o)
                    }))
                }
            }, {
                ...
                key: "setValueMethod", value: function (e, t) {
                    ...
                    this.beforeValueSet(), this.setValue(s, {disableEvent: t}), this.afterValueSet()
                }
            }, {
                key: "setGroupOptionsValue", value: function (e) {
                    var t = [], i = {}, o = {};
                    return e.forEach((function (e) {
                        o[e] = !0
                    })), this.options.forEach((function (e) {
                        var s = e.value, n = !0 === o[s];
                ...
                key: "setDisabledOptions", value: function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = [];
                    if (e) if (!0 === e) t && this.options.forEach((function (e) {
                ...
                key: "setOptions", value: function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = [],
                        i = this.disabledOptions.length, o = this.valueKey, n = this.labelKey, r = this.descriptionKey,
                        a = this.aliasKey, l = this.hasOptionDescription, u = s.getString, p = s.convertToBoolean,
                        h = this.secureText.bind(this), c = this.getAlias.bind(this), f = 0, y = !1, b = {}, g = !1;
                    this.disabledOptions.forEach((function (e) {
                        b[e] = !0
                    }));
                    var m = function e(s) {
                        var m;
                        "object" !== v(s) && (d(m = {}, o, s), d(m, n, s), s = m);
                        var O = h(u(s[o])), S = s.options, x = !!S, w = {
                            index: f,
                            value: O,
                            label: h(u(s[n])),
                            alias: c(s[a]),
                        ...
                        if (g || "" !== O || (g = !0), i && (w.isDisabled = !0 === b[O]), s.isGroupOption && (w.isGroupOption = !0, w.groupIndex = s.groupIndex), l && (w.description = h(u(s[r]))), s.customData && (w.customData = s.customData), t.push(w), f += 1, x) {
                            var k = w.index;
                            y = !0, S.forEach((function (t) {
                                t.isGroupOption = !0, t.groupIndex = k, e(t)
                            }))
                        }
                    };
                    Array.isArray(e) && e.forEach(m);
                    var O = t.length, S = this.$ele;
                    S.options = t, S.length = O, this.options = t, this.visibleOptionsCount = O, this.lastOptionIndex = O - 1, this.newValues = [], this.hasOptionGroup = y, this.hasEmptyValueOption = g, this.setSortedOptions()
                }
            }, {
                key: "setServerOptions", value: function () {
                    var e = this, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
                    this.setOptionsMethod(t, !0);
                    var i = this.selectedOptions, o = this.options, s = !1;
                    if (i.length) {
                        var n = {};
                ...
                key: "setVisibleOptions", value: function () {
                    var e = y(this.sortedOptions), t = 2 * this.optionsCount, i = this.getVisibleStartIndex(),
                        o = this.getNewOption(), s = i + t - 1, n = 0;
                ...
                key: "setOptionsTooltip", value: function () {
                    var e = this, t = this.getVisibleOptions(), i = this.hasOptionDescription;
                ...
                key: "setValue", value: function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, i = t.disableEvent,
                        o = void 0 !== i && i, n = t.disableValidation, r = void 0 !== n && n,
                ...
                key: "setValueText", value: function () {
                    var e = this.multiple, t = this.selectedValues, i = this.noOfDisplayValues,
                        o = this.showValueAsTags, s = this.$valueText, n = [], r = [], a = t.length, l = 0,
                        u = this.isAllSelected && !this.hasServerSearch && !this.disableAllOptionsSelectedText && !o;
                    if (u && this.hideValueTooltipOnSelectAll) s.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(a, ")"); else {
                        this.getSelectedOptions({fullDetails: !0, keepSelectionOrder: !0}).some((function (e) {
                        ...
                        var c = n.join(", ");
                        if ("" === c) s.innerHTML = this.placeholder; else if (s.innerHTML = c, e) {
                            var d = this.maxValues;
                            if (this.alwaysShowSelectedOptionsCount || p.hasEllipsis(s) || d || o) {
                                var v = '<span class="vscomp-selected-value-count">'.concat(a, "</span>");
                                if (d && (v += ' / <span class="vscomp-max-value-count">'.concat(d, "</span>")), u) s.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(a, ")"); else if (o) s.innerHTML = r.join(""), this.$valueTags = s.querySelectorAll(".vscomp-value-tag"), this.setValueTagAttr(); else if (!this.alwaysShowSelectedOptionsLabel) {
                ...
                key: "setVisibleOptionsCount", value: function () {
                    var e, t = 0, i = !1, o = this.searchValue, s = this.searchGroup, n = this.showOptionsOnlyOnSearch,
                        r = this.searchByStartsWith, a = this.isOptionVisible.bind(this);
                ...
                key: "setOptionProp", value: function (e, t, i) {
                ...
                key: "setNewOptionsFromValue", value: function (e) {
                    if (e) {
                        var t = this.setNewOption.bind(this), i = {};
                        this.options.forEach((function (e) {
                            i[e.value] = !0
                        })), e.forEach((function (e) {
                            e && !0 !== i[e] && t(e)
                ...
                key: "setOptionAttr", value: function () {
                    var e = this.$visibleOptions, t = this.options, i = "".concat(this.optionHeight, "px"),
                        o = p.setStyle, s = p.getData, n = p.setData;
                ...
                key: "setValueTagAttr", value: function () {
                    ...
                    if (e && e.length) {
                        var t = p.getData, i = p.setData, o = this.options;
                        e.forEach((function (e) {
                            var s = t(e, "index");
                            if (void 0 !== s) {
                                var n = o[s];
                ...
                key: "getInputValue", value: function (e) {
                    var t = e;
                ...
                key: "getOptionObj", value: function (e) {
                    if (e) {
                        var t = s.getString, i = this.secureText.bind(this);
                        return {
                            index: e.index,
                            value: i(t(e.value)),
                            label: i(t(e.label)),
                ...
                key: "getSelectedOptions", value: function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = e.fullDetails,
                        i = void 0 !== t && t, o = e.keepSelectionOrder, s = void 0 !== o && o, n = this.valueKey,
                        r = this.labelKey, a = this.selectedValues, l = [];
                    if (this.options.forEach((function (e) {
                        if (e.isSelected && !e.isGroupTitle) if (i) l.push(e); else {
                ...
                key: "getDisabledOptions", value: function () {
                    var e = this.valueKey, t = this.labelKey, i = this.disabledOptions, o = {}, s = [];
                    return i.forEach((function (e) {
                        o[e] = !0
                    })), this.options.forEach((function (i) {
                        var n, r = i.value, a = i.label;
                        o[r] && s.push((d(n = {}, e, r), d(n, t, a), n))
                    })), s
                }
            }, {
                key: "getVisibleOptionGroupsMapping", value: function (e) {
                    var t = this.options, i = {}, o = this.isOptionVisible.bind(this);
                ...
                key: "getSibling", value: function (e, t) {
                    var i = "next" === t ? "nextElementSibling" : "previousElementSibling", o = e;
                    do {
                        o && (o = o[i])
                ...
                key: "focusOption", value: function () {
                    var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, i = t.direction,
                        o = t.$option, s = t.focusFirst,
                        n = this.$dropboxContainer.querySelector(".vscomp-option.focused");
                    if (o) e = o; else if (!n || s) {
                ...
                key: "moveFocusedOptionToView", value: function (e) {
                    ...
                    if (t) {
                        var i, o = this.$optionsContainer.getBoundingClientRect(), s = t.getBoundingClientRect(),
                            n = o.top, r = o.bottom, a = o.height, l = s.top, u = s.bottom, h = s.height,
                            c = t.offsetTop, d = p.getData(this.$options, "top", "number");
                ...
                key: "selectOption", value: function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, i = t.event;
                    if (e) {
                        ...
                        var n = this.selectedValues, r = p.getData(e, "value"), a = p.getData(e, "index", "number"),
                            l = p.hasClass(e, "current-new"), u = !1, h = this.lastSelectedOptionIndex;
                        if (this.lastSelectedOptionIndex = null, this.toggleSelectedProp(a, o), o) {
                            if (this.multiple) n.push(r), this.toggleAllOptionsClass(), this.toggleGroupOptionsParent(e), i && i.shiftKey && (u = !0); else {
                ...
                key: "selectRangeOptions", value: function (e, t) {
                    ...
                    if ("number" == typeof e && !this.maxValues) {
                        var o, s, n = this.selectedValues, r = this.hasOptionGroup, a = {};
                ...
                key: "toggleAllOptions", value: function (e) {
                    if (this.multiple && !this.disableSelectAll) {
                        var t = "boolean" == typeof isSelected ? e : !p.hasClass(this.$toggleAllCheckbox, "checked"),
                            i = [], o = this.selectAllOnlyVisible;
                        this.options.forEach((function (e) {
                            var s = e;
                            if (!s.isDisabled && !s.isCurrentNew) {
                                var n = s.isVisible, r = s.isSelected;
                ...
                key: "toggleAllOptionsClass", value: function (e) {
                    if (this.multiple) {
                        var t = !1;
                        "boolean" == typeof e || (e = this.isAllOptionsSelected()), !e && this.selectAllOnlyVisible && (t = this.isAllOptionsSelected(!0)), p.toggleClass(this.$toggleAllCheckbox, "checked", e || t), this.isAllSelected = e
                    }
                }
            }, {
                key: "isAllOptionsSelected", value: function (e) {
                    var t = !1;
                ...
                key: "toggleGroupOptions", value: function (e, t) {
                    var i = this;
                    if (this.hasOptionGroup && !this.disableOptionGroupCheckbox && e) {
                        var o = p.getData(e, "index", "number"), n = this.selectedValues, r = this.selectAllOnlyVisible,
                            a = {}, l = s.removeItemFromArray;
                ...
                key: "reset", value: function () {
                    ...
                    this.options.forEach((function (e) {
                        e.isSelected = !1
                    })), this.beforeValueSet(!0), this.setValue(null, {disableValidation: e}), this.afterValueSet(), e && p.removeClass(this.$allWrappers, "has-error"), p.dispatchEvent(this.$ele, "reset")
                }
            }, {
                key: "addOption", value: function (e, t) {
                    if (e) {
                        this.lastOptionIndex += 1;
                        var i = this.getOptionObj(c(c({}, e), {}, {index: this.lastOptionIndex}));
                ...
                key: "sortOptions", value: function (e) {
                    return e.sort((function (e, t) {
                        var i = e.isSelected || e.isAnySelected, o = t.isSelected || t.isAnySelected;
                        return i || o ? i && (!o || e.index < t.index) ? -1 : 1 : 0
                    }))
                }
            }, {
                key: "sortOptionsGroup", value: function (e) {
                    var t = this.sortOptions.bind(this), i = this.structureOptionGroup(e);
                    return i.forEach((function (e) {
                        var i = e.options;
                ...
                key: "isOptionVisible", value: function (e) {
                    var t = e.data, i = e.searchValue, o = e.hasExactOption, s = e.visibleOptionGroupsMapping,
                        n = e.searchGroup, r = e.searchByStartsWith, a = t.value.toLowerCase(),
                        l = t.label.toLowerCase(), u = t.description, p = t.alias,
                ...
                key: "removeValue", value: function (e) {
                    var t = this.selectedValues, i = p.getData(e, "value");
                ...
                key: "validate", value: function () {
                    ...
                    var e = !1, t = this.selectedValues, i = this.minValues;
    ...
    var i = function () {
        ...
        var i;
        return (i = [{
            key: "addClass", value: function (i, o) {
            ...
            key: "removeClass", value: function (i, o) {
                i && (o = o.split(" "), t.getElements(i).forEach((function (t) {
                    var i;
            ...
            key: "getMoreVisibleSides", value: function (e) {
                if (!e) return {};
                var t = e.getBoundingClientRect(), i = window.innerWidth, o = window.innerHeight, s = t.left, n = t.top;
                return {
            ...
            key: "getAbsoluteCoords", value: function (e) {
                if (e) {
                    var t = e.getBoundingClientRect(), i = window.pageXOffset, o = window.pageYOffset;
                    return {
                        width: t.width,
                        height: t.height,
                        top: t.top + o,
        ...
        return (t = [{
            ...
            key: "setPosition", value: function () {
                ...
                var e, t, n, r = window.innerWidth, a = window.innerHeight, l = i.getAbsoluteCoords(this.$popperEle),
                    u = i.getAbsoluteCoords(this.$triggerEle), p = l.width, h = l.height, c = l.top, d = l.right,
                    v = l.bottom, f = l.left, y = u.width, b = u.height, g = u.top, m = u.right, O = u.bottom,
                    S = u.left, x = g - c, w = S - f, k = w, E = x, C = this.position, A = this.secondaryPosition,
                    $ = y / 2 - p / 2, T = b / 2 - h / 2, D = this.margin, V = this.transitionDistance,
                    P = window.scrollY - c, I = a + P, M = window.scrollX - f, F = r + M, G = this.offset;
                ...
                if (i.setStyle(this.$popperEle, "transform", N), i.setData(this.$popperEle, "fromLeft", t), i.setData(this.$popperEle, "fromTop", e), i.setData(this.$popperEle, "top", E), i.setData(this.$popperEle, "left", k), i.removeClass(this.$popperEle, o.join(" ")), i.addClass(this.$popperEle, "position-".concat(C)), this.hasArrow) {
                    var q = 0, j = 0, R = k + f, B = E + c, z = this.$arrowEle.offsetWidth / 2, K = s[C] || "";
            ...
            key: "show", value: function () {
                ...
                clearTimeout(this.exitDelayTimeout), clearTimeout(this.hideDurationTimeout), o && this.resetPosition(), this.enterDelayTimeout = setTimeout((function () {
                    var t = i.getData(e.$popperEle, "left"), o = i.getData(e.$popperEle, "top"),
                        n = "translate3d(".concat(t, "px, ").concat(o, "px, 0)"), r = e.showDuration;
            ...
            key: "hide", value: function () {
                ...
                clearTimeout(this.enterDelayTimeout), clearTimeout(this.showDurationTimeout), this.exitDelayTimeout = setTimeout((function () {
                    if (e.$popperEle) {
                        var t = i.getData(e.$popperEle, "fromLeft"), s = i.getData(e.$popperEle, "fromTop"),
                            n = "translate3d(".concat(t, "px, ").concat(s, "px, 0)"), r = e.hideDuration;
        ...
        return i = t, (o = [{
            ...
            key: "throttle", value: function (e, t) {
                ...
                return function () {
                    ...
                    var a = (new Date).getTime(), l = t - (a - o);
                    clearTimeout(i), l <= 0 ? (o = a, e.apply(void 0, n)) : i = setTimeout((function () {
                        e.apply(void 0, n)
                    }), l)
                }
            }
        }]) && e(i, o), Object.defineProperty(i, "prototype", {writable: !1}), t
    }();
    ...
    var n = function () {
        ...
        return o = e, (n = [{
            ...
            key: "removeEvent", value: function (t, i, o) {
                e.addOrRemoveEvent(t, i, o, "remove")
            }
        }, {
            key: "addOrRemoveEvent", value: function (i, o, s, n) {
            ...
            key: "getScrollableParents", value: function (e) {
                ...
                for (var t = [window], i = e.parentElement; i;) {
                    var o = getComputedStyle(i).overflow;
                    -1 === o.indexOf("scroll") && -1 === o.indexOf("auto") || t.push(i), i = i.parentElement
                }
                return t
            }
        }, {
        ...
        }]) && s(o, n), Object.defineProperty(o, "prototype", {writable: !1}), e
    }();
    ...
    var a, l = {27: "onEscPress"},
        ...
        p = function () {
            ...
            return i = e, s = [{
                ...
                key: "getAttrProps", value: function () {
                    var e = n.convertPropToDataAttr, t = {};
                ...
                key: "addOrRemoveEvents", value: function (e) {
                    ...
                    this.getEvents().forEach((function (i) {
                        t.addOrRemoveEvent({action: e, $ele: i.$ele, events: i.event, method: i.method})
                    }))
                }
            }, {
                key: "addEvents", value: function () {
                ...
                key: "addOrRemoveEvent", value: function (e) {
                    var i = this, o = e.action, s = e.$ele, r = e.events, a = e.method, l = e.throttle;
                    s && (r = t.removeArrayEmpty(r.split(" "))).forEach((function (e) {
                        var r = "".concat(a, "-").concat(e), u = i.events[r];
                ...
                key: "onDocumentClick", value: function (e) {
                    var t = e.target, i = t.closest(".pop-comp-ele"), o = t.closest(".pop-comp-wrapper");
                    this.hideOnOuterClick && i !== this.$ele && o !== this.$popover && this.hide()
                }
            }, {
                key: "onDocumentKeyDown", value: function (e) {
                    var t = e.which || e.keyCode, i = l[t];
                    i && this[i](e)
                }
            }, {
            ...
            }]) && r(i.prototype, o), s && r(i, s), Object.defineProperty(i, "prototype", {writable: !1}), e
        }();
